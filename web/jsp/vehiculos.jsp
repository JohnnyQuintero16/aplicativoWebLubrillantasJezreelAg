            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<%=basePath%>jsp/servicios.jsp">SERVICIOS</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<%=basePath%>jsp/productos.jsp">PRODUCTOS</a>
                        </li>
                    </ul>
                    ...
                    <div class="vehiculo-datos">
                        <table class="tabla-vehiculo">
                            ...
                            <tr>
                                <td>Lorem</td>
                                <td>2021</td>
                                <td><img src="<%=basePath%>img/papelera.png" alt="papelera" style="width: 1.5rem; height: 1.5rem;"></td>
                            </tr>
