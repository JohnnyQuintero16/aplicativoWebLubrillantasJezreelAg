...
<body>
	...
	<nav class="navbar navbar-expand-lg sticky-top navbar-dark bg-primary">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
          <a class="nav-link active" href="<%=basePath%>/html/nosotros.jsp">NOSOTROS</a>
          </li>
          <li class="nav-item">
          <a class="nav-link" href="<%=basePath%>/servicios.jsp">SERVICIOS</a>
          </li>
          <li class="nav-item">
          <a class="nav-link " aria-current="page"href="<%=basePath%>/productos.jsp">PRODUCTOS</a>
          </li>
			</ul>

			<ul class="navbar-nav ml-auto m-4">
				<li class="nav-item">
					<a class="nav-link" href="<%=basePath%>/iniciarsesion.jsp">INICIAR SESIÃN</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="<%=basePath%>/registrarse.jsp">REGISTRARSE</a>
				</li>
			</ul>
